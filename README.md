...
<img width="441" alt="Screenshot 2024-09-05 at 8 54 51 PM" src="https://github.com/user-attachments/assets/f35be0a3-58be-46a1-bfd4-f829c6f62778">
...
<img width="366" alt="Screenshot 2024-09-05 at 6 14 44 PM" src="https://github.com/user-attachments/assets/78a6f12a-b5c4-40d3-ade2-2a72c7e77aed">
...
- For the wall of the back of the house, we used one single cube and kept the rotation as normal (0º degrees). We positioned it to connect both walls giving us our base for our house to finally be complete.

<img width="361" alt="2" src="https://github.com/user-attachments/assets/78c1d7bc-b8e7-4c9f-9555-6fbc51261c12">
...
- Although we had a rough start with some errors that would ocurr, we eventually were able to overcome them with the help of other classmates, which provided us with new knowledge on how to deal with future errors, if any. In regards to the assignment itself, it was fun being able to create something more concrete rather than abstract, despite being pretty simple. I also enjoyed being able to work with my other teamates on the same project as this allowed us to begin developing a good team dynamic and communication for the more difficult proyects that lie ahead of us. I've always wanted to learn a bit on game engines, and so far, I've been trully loving the experience.
> Nicole A. Vallejo Chinea

- Personally, I really enjoy working with the program Unity. I have experience with art programs that have a large quantity of tools and assets which included 3D objects. I have only ever used pre-made 3D models with the purpose of posing and creating references for art, and even then I found it difficult to manipulate the axis' and camera. After playing with 3D objects in Unity I'm finally starting to get more comfortable with 3D objects. I definitely liked making a simple drawing of what we wanted and planning how we were going to divide the different parts of the build. Building the actual model in Unity was frustrating and slow going sometimes but it was a good exercise to get used to the program and overall it was gratifying to have a nice clean end result.
